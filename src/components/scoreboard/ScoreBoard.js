...
export const ScoreBoard = () => {
  const { correct:[correct], incorrect:[incorrect], revealed:[revealed], streak:[streak] } = useContext(ScoreContext)
  ...
  return (
    <div className='score-container'>
      ...
      <h5 className="streak">Streak: </h5>
      <h3 className="score-streak">{streak}</h3>
    </div>
  )
}
